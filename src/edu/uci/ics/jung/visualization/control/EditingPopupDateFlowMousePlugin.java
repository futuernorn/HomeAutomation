 ...
 *
 *
 * Changes made to original EditingPopupGraphMousePlugin class for purposes of 
 * org.cs4398g4 Home Automation project
 */
public class EditingPopupDateFlowMousePlugin<V,E> extends AbstractPopupGraphMousePlugin {
    
    protected Factory<V> vertexFactory;
    protected Factory<E> edgeFactory;
    protected JPopupMenu popup = new JPopupMenu();

    public EditingPopupDateFlowMousePlugin(Factory<V> vertexFactory, Factory<E> edgeFactory) {
...
//            			popup.add(undirectedMenu);
            			for(final V other : picked) {
            				...
            				if (other != vertex) {
            					popup.add(new AbstractAction("Create Connection [" + other+","+vertex+"]") {
	            					public void actionPerformed(ActionEvent e) {
	            						graph.addEdge(edgeFactory.create(),
	            								other, vertex);
	            						vv.repaint();

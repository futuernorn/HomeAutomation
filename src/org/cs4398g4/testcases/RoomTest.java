...
public class RoomTest {
	...
	public void AddComponentsTest() {
		...
		assertEquals("Room should have no actuators when created", 0, RoomTester.getComponents(Actuator.class).size());
		assertEquals("Room should have no sensors when created", 0, RoomTester.getComponents(Sensor.class).size());
		...
		assertEquals("Room should contain one sensor", 1, RoomTester.getComponents(Actuator.class).size());
		assertEquals("Room should contain one light", 1, RoomTester.getComponents(Sensor.class).size());
